...
def slam_eval2():
    ...
    print('---------------------------------------------------------------------------------------')
    for i in range(len(taglist)):
        print('%3d %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f\n' % (taglist[i], gt_vec[0][i], us_vec[0][i], diff[0][i], gt_vec[1][i], us_vec[1][i], diff[1][i], us_vec_aligned[0][i], us_vec_aligned[1][i]))
    ...
    ax.set_xticks([-1.6, -1.2, -0.8, -0.4, 0, 0.4, 0.8, 1.2, 1.6])
    ax.set_yticks([-1.6, -1.2, -0.8, -0.4, 0, 0.4, 0.8, 1.2, 1.6])
    plt.legend(['Real','Predicted','Pred_aligned(TrueMap)'])
    plt.grid()
    plt.show()
